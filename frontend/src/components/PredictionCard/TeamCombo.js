    ...
    <div className="card">
      ...
      <div className="card-body bg-gray">
        <p className="card-title d-flex justify-content-between">
          <div className=''>
            <span className='ra11-bg-dark p-1 text-dark'>Select any one combination from</span>
            <span className='bg-dark p-2 fw-600 text-white badge'>{'combo.length'}</span>
          </div>
          <div className=''>
            <span className='ra11-bg-primary p-1'>Selected combination</span>
            <span className='bg-dark p-2 fw-600 text-white badge'>{'selectedteamcombo'}</span>
          </div>
        </p>
